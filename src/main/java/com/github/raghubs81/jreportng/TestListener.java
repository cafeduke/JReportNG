...
import com.github.raghubs81.jreportng.TestClassResultManager.MethodResultState;
...
/**
 * Listen to only top level test run life-cycle events not handled by watchers in {@link com.github.raghubs81.jreportng.AbstractTestCase AbstractTestCase}  
 * Provide static loggers that log by obtaining the logger from the test class in {@link org.junit.runner.Description Description}.
 * 
...
public class TestListener implements ITestListener, ISuiteListener, IExecutionListener, IConfigurationListener
{
    ...
    * {@link org.junit.runner.Description Description} 
    * 
    * @param description org.junit.runner.Description object
    ...
    *                   
    * @see #log(String, Description, Level, String, Throwable)
   ...
   /**
    * Invoke log (mesg, description, Level.INFO, null, null)
    *                   
    * @see #log(String, Description, Level, String, Throwable)
    * @param mesg Message to be logged
    * @param description Description object having the source of the message.
    */
   ...
   /**
    * Invoke log (mesg, description, level, styleClass, null);
    * @see #log(String, Description, Level, String, Throwable)
    * 
    * @param mesg Message to be logged
    * @param description Description object having the source of the message.
   ...
   /**
    * Invoke log (mesg, description, level, null, e);
    * @see #log(String, Description, Level, String, Throwable)
    * 
    * @param mesg Message to be logged
    * @param description Description object having the source of the message.
    ...
    * @param thrown The stack trace of the Throwable to be logged.
    */
   private static void log (String mesg, ITestResult result, Level level, String styleClass, Throwable thrown)
   {
      Class<?> testClass = (result == null || result.getTestClass()  == null) ? JREPORT_LOG_DEFAULT_CLASS : result.getTestClass().getRealClass();
      String  testMethod = (result == null || result.getMethod() == null) ? "" : result.getMethod().getMethodName();
